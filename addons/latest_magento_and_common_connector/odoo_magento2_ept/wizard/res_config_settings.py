...
class ResConfigSettings(models.TransientModel):
    ...
    def _get_magento_default_financial_statuses(self):
        if self.env.context.get('default_magento_instance_id', False):
            financial_status_ids = self.env[MAGENTO_FINANCIAL_STATUS_EPT].search(
                [('magento_instance_id', '=',
                  self.env.context.get('default_magento_instance_id', False))]).ids
    ...
    import_order_on = fields.Selection([("created_at", "Created At"), ("updated_at", "Updated At")],
                                       copy=False, default="updated_at")
    mag_import_disable_products = fields.Boolean("Import Disabled Products", default=False,
    ...
    def onchange_magento_instance_id(self):
        ...
        if magento_instance_id:
            self.write({
                ...
                "mag_import_disable_products": magento_instance_id.import_disable_products or False,
    ...
    def write_instance_vals(self, magento_instance_id):
        ...
        values.update({
            ...
            "import_disable_products": self.mag_import_disable_products or False,
