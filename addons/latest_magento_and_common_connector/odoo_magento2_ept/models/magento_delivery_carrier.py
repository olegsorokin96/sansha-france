...
class MagentoDeliveryCarrier(models.Model):
    ...
    _unique_magento_delivery_code = models.Constraint(
    ...
    def name_get(self):
        ...
        for delivery in self:
            ...
            if delivery.carrier_label:
                name = "[" + delivery.carrier_label + "]  " + delivery.carrier_code + instance_name if instance_name else delivery.carrier_code
            else:
                name = delivery.carrier_code + instance_name if instance_name else delivery.carrier_code
