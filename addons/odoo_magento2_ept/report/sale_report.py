...
class SaleReport(models.Model):
    ...
    def _select_additional_fields(self):
        ...
        res['magento_instance_id'] = "s.magento_instance_id"
        res['magento_website_id'] = "s.magento_website_id"
        return res

    def _group_by_sale(self):
        res = super()._group_by_sale()
        res += """,
            s.magento_instance_id, s.magento_website_id"""
        return res
    ...
    def magento_sale_report(self):
        ...
        if version_info.get('server_version') == '18.0':
