...
class DeliveryCarrier(models.Model):
    ...
    def find_delivery_carrier(self, item, instance, log_line, line):
        ...
        if method:
            ...
            if not magento_carrier:
                ...
                """)
                log_line.create_common_log_line_ept(message=message, order_ref=line.magento_id, module='magento_ept',
