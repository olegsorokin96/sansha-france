...
class MagentoProductImage(models.Model):
    ...
    def default_get(self, fields):
        ...
        if self._context.get("default_magento_tmpl_id"):
            vals["magento_tmpl_id"] = self._context["default_magento_tmpl_id"]

        if self._context.get("default_magento_product_id"):
            vals["magento_product_id"] = self._context["default_magento_product_id"]
