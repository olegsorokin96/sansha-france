...
class MagentoProductProduct(models.Model):
    ...
    _magento_product_unique_constraint = models.Constraint(
    ...
    def _prepare_product_values(self, item):
        values = {
            ...
            # 'type': 'product' if not self.env.context.get('product_type_service') else 'service',
            'type': 'consu' if not self.env.context.get('product_type_service') else 'service',
            'is_storable': True if not self.env.context.get('product_type_service') else False,
