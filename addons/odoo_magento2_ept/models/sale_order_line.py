...
class SaleOrderLine(models.Model):
    ...
    def create_order_line(self, item, instance, log_line, line_id):
        ...
        for line in order_lines:
            ...
            # ✅ FIXED PRICE SOURCE (SEE METHOD BELOW)
            ...
            new_order_line = self.create(line_vals)
            new_order_line.with_context(round=rounding)._compute_amount()
    ...
    def __find_order_item_price(self, item, order_line, instance):
        ...
        - This matches Magento Admin -> Items Ordered -> Price
        """
        ...
        if price is None:
            raise ValueError(
                f"Magento order line {order_line.get('item_id')} has no 'price' field"
            )
